...
Namespace WindowsApplication29
	Partial Public Class Form1
		...
		Private Function GetCheckValue(ByVal node As DevExpress.XtraTreeList.Nodes.TreeListNode) As Nullable(Of Boolean)
		...
		Protected Sub DrawCheckBox(ByVal g As Graphics, ByVal r As Rectangle, ByVal Checked As Nullable(Of Boolean))
		...
		Private Sub treeList1_CellValueChanged(ByVal sender As Object, ByVal e As CellValueChangedEventArgs) Handles treeList1.CellValueChanged
			If e.Column.FieldName = "Bool0" OrElse e.Column.FieldName = "Bool1" Then
				CType(sender, TreeList).InvalidateNode(e.Node)
			End If
		End Sub
	End Class
End Namespace